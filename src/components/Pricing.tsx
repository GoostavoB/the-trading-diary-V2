          ...
          <div className="text-center mb-8 md:mb-12 animate-fade-in">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all ${billingCycle === 'monthly'
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all relative ${billingCycle === 'annual'
                  ? 'bg-primary text-primary-foreground'
                  : 'text-muted-foreground hover:text-foreground'
                  }`}
              >
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-6" role="list">
            {plans.map((plan, index) => (
              <article
                role="listitem"
                key={plan.id}
                className={`glass backdrop-blur-[12px] rounded-2xl p-6 md:p-8 relative hover-lift transition-all shadow-sm animate-fade-in ${plan.popular ? "ring-2 ring-primary shadow-lg shadow-primary/20" : ""
                  }`}
              ...
              >
                ...
                <Button
                  ...
                  className={`w-full h-12 mb-3 rounded-xl font-medium transition-all ${plan.popular
                ...
                <ul className="space-y-2.5">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <Check
                        size={18}
                        className={`mt-0.5 flex-shrink-0 ${plan.popular ? "text-primary" : "text-foreground"
                          }`}
                      />

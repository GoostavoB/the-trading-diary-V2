              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-start gap-3 flex-1">
                    <div
                      className={`p-2 rounded-lg ${isCompleted ? 'bg-neon-green/20' : 'bg-primary/20'
                        }`}
                    >
                      <Icon
                        className={`w-4 h-4 ${isCompleted ? 'text-neon-green' : 'text-primary'
                          }`}
                      />
                    </div>

...
const faqs = [
  ...
  {
    question: 'How does BullBear Journal help me become a better trader?',
    answer: 'BullBear Journal provides analytics, performance tracking, and insights from your trading history. By analyzing your wins and losses, emotional patterns, and strategy effectiveness, you can make data-driven improvements to your trading approach.'
  },
  {
    question: 'Can I track both crypto and stock trades?',
    answer: 'Yes! BullBear Journal supports all asset types including cryptocurrencies, stocks, forex, commodities, and more. Simply enter the asset name when logging your trade.'
  },
  {
    ...
    <AppLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Find answers to common questions about BullBear Journal</p>
        </div>

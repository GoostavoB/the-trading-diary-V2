      ...
      <PremiumFeatureLock requiredPlan="pro" isLocked={isPremiumLocked}>
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <PremiumCard>
              <div className="p-6 pb-3 flex flex-row items-center justify-between space-y-0 pb-2">
                <h3 className="text-2xl font-semibold leading-none tracking-tight">Net P&amp;L</h3>
            ...
            <PremiumCard>
              <div className="p-6 pb-3 flex flex-row items-center justify-between space-y-0 pb-2">
                <h3 className="text-2xl font-semibold leading-none tracking-tight">Total Gains</h3>
            ...
            <PremiumCard>
              <div className="p-6 pb-3 flex flex-row items-center justify-between space-y-0 pb-2">
                <h3 className="text-2xl font-semibold leading-none tracking-tight">Total Losses</h3>
            ...
            <PremiumCard>
              <div className="p-6 pb-3 flex flex-row items-center justify-between space-y-0 pb-2">
                <h3 className="text-2xl font-semibold leading-none tracking-tight">Total Fees</h3>
          ...
          <Tabs defaultValue="summary" className="space-y-4">
            ...
            <TabsContent value="summary" className="space-y-4">
              <PremiumCard>
                <div className="p-6 pb-3">
                  <h3 className="text-2xl font-semibold leading-none tracking-tight">Tax Summary for {selectedYear}</h3>
            ...
            <TabsContent value="short-term">
              <PremiumCard>
                <div className="p-6 pb-3">
                  <h3 className="text-2xl font-semibold leading-none tracking-tight">Short-term Trades</h3>
                  <p className="text-sm text-muted-foreground">
            ...
            <TabsContent value="long-term">
              <PremiumCard>
                <div className="p-6 pb-3">
                  <h3 className="text-2xl font-semibold leading-none tracking-tight">Long-term Trades</h3>
                  <p className="text-sm text-muted-foreground">

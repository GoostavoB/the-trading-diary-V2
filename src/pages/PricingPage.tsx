  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "200 AI extracts/month",
        "Unused extracts rollover",
        "Top-up extract packs",
        "25% discount on extra packs",
      ],

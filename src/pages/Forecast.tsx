      ...
      <PremiumFeatureLock requiredPlan="pro" isLocked={isPremiumLocked}>
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          {loading ? (
            ...
            <>
              <PremiumCard className="p-6 glass-card border-border/50">
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    <div className="p-5 glass-subtle rounded-xl border border-border/30">
                      ...
                      <p className={`text-3xl font-bold ${avgDailyPnl === 0
                          ? 'text-foreground'
                          : avgDailyPnl > 0
                            ? 'text-success'
                            : 'text-destructive'
                    ...
                    <div className="p-5 glass-subtle rounded-xl border border-border/30">
                      ...
                      <p className={`text-3xl font-bold ${projectedEquity === 0
                          ? 'text-foreground'
                          : projectedEquity > 0
                            ? 'text-success'
                            : 'text-destructive'
              ...
              <PremiumCard className="p-5 glass-card border-warning/30 bg-warning/5">
              ...
              <div className="space-y-8 mt-16">
                ...
                {advancedStats ? (
                  ...
                  <PremiumCard className="p-16 text-center glass-card border-border/50">

  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div key={category.category} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {category.items.map((item) => (
                <PremiumCard key={item.title} className="p-6 space-y-4 hover:shadow-lg transition-all hover:scale-[1.01]">
        ...
        {/* CTA */}
        <PremiumCard className="p-12 text-center bg-gradient-to-br from-primary/10 to-primary/5">

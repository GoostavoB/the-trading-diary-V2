...
const BackTests = lazyWithRetry(() => import("./pages/BackTests"));
const BacktestBumerangue = lazyWithRetry(() => import("./pages/BacktestBumerangue"));
const Analytics = lazyWithRetry(() => import("./pages/Analytics"));
const Forecast = lazyWithRetry(() => import("./pages/Forecast"));
const Achievements = lazyWithRetry(() => import("./pages/Achievements"));

const MarketData = lazyWithRetry(() => import("./pages/MarketData"));
const LSROIGrid = lazyWithRetry(() => import("./pages/LSROIGrid"));
const Settings = lazyWithRetry(() => import("./pages/Settings"));
const Blog = lazyWithRetry(() => import("./pages/Blog"));
const BlogPost = lazyWithRetry(() => import("./pages/BlogPost"));
const Author = lazyWithRetry(() => import("./pages/Author"));
const FAQ = lazyWithRetry(() => import("./pages/FAQ"));
const CryptoTradingFAQ = lazyWithRetry(() => import("./pages/CryptoTradingFAQ"));
...
const TradingPlan = lazyWithRetry(() => import("./pages/TradingPlan"));
const NotFound = lazyWithRetry(() => import("./pages/NotFound"));
const CustomPage = lazyWithRetry(() => import("./pages/CustomPage"));
const ExchangeConnections = lazyWithRetry(() => import("./pages/ExchangeConnections"));
const ExchangeTutorial = lazyWithRetry(() => import("./pages/ExchangeTutorial"));
const SpotWallet = lazyWithRetry(() => import("./pages/SpotWallet"));
const FeeAnalysis = lazyWithRetry(() => import("./pages/FeeAnalysis"));
const CapitalManagementPage = lazyWithRetry(() => import("./pages/CapitalManagementPage"));
const LogoDownload = lazyWithRetry(() => import("./pages/LogoDownload"));
const LogoGenerator = lazyWithRetry(() => import("./pages/LogoGenerator"));
// Phase 2: Leaderboard feature - temporarily disabled for backlog #34
// const Leaderboard = lazyWithRetry(() => import("./pages/Leaderboard"));
const LongShortRatio = lazyWithRetry(() => import("./pages/LongShortRatio"));
const PublicLongShortRatio = lazyWithRetry(() => import("./pages/PublicLongShortRatio"));
...
// const PerformanceAlerts = lazyWithRetry(() => import("./pages/PerformanceAlerts"));
// Phase 2: Progress Analytics (IXP/XP) - temporarily disabled for backlog #36 (visual redesign pending)
// const ProgressAnalytics = lazyWithRetry(() => import("./pages/ProgressAnalytics"));
const MyMetrics = lazyWithRetry(() => import("./pages/MyMetrics"));
...
const AcademyChartPatterns = lazyWithRetry(() => import("./pages/AcademyChartPatterns"));
const AcademyPatterns = lazyWithRetry(() => import("./pages/AcademyPatterns"));
    ...
    <>
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/back-tests" element={<ProtectedRoute><BackTests /></ProtectedRoute>} />
          <Route path="/back-tests/bumerangue" element={<ProtectedRoute><BacktestBumerangue /></ProtectedRoute>} />
